...
public interface UserOperations {
    ...
    @GetMapping("/{id}")
    ResponseEntity<UserEntity> findUserById(@PathVariable("id") Long id) throws Exception;
    ...
    @PutMapping("/{id}")
    ResponseEntity<UserEntity> updateUser(@PathVariable("id") Long id, @RequestBody UserEntity user);
    ...
    @DeleteMapping("/{id}")
    ResponseEntity<Void> removeUser(@PathVariable("id") Long id) throws Exception;
}
